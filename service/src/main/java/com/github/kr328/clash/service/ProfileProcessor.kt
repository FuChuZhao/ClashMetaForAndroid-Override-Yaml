...
import com.github.kr328.clash.service.util.globalProfileOverrideDir
...
object ProfileProcessor {
    ...
    private fun ensureOverrideDirs(context: Context) {
        context.globalProfileOverrideDir.mkdirs()
        context.processingDir.profileOverrideDir.mkdirs()
    }

    private fun applyProfileOverrides(context: Context) {
        ensureOverrideDirs(context)
        Clash.applyProfileOverrides(context.processingDir, context.globalProfileOverrideDir)
    }
