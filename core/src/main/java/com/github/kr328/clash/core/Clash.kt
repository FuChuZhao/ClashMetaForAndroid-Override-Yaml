...
object Clash {
    ...
    fun applyProfileOverrides(path: File, globalOverrideDir: File) {
        Bridge.nativeApplyProfileOverrides(path.absolutePath, globalOverrideDir.absolutePath)?.also {
            throw ClashException(it)
        }
    }
